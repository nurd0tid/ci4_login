...
class AuthController extends Controller
{
	...
	public function attemptRegister()
	{
		...
		$rules = [
			'firstname'     => 'required',
			'lastname'      => 'required',
			// 'photo'         => 'uploaded[photo]|is_image[photo]|mime_in[photo,image/jpg,image/jpeg,image/gif,image/png,image/webp]',
		...
		$dataBerkas->move('uploads/img/', $fileName);
		// $allowedPostFields = array_merge(['password'], $this->config->validFields, $fileName = $this->config->fileFields, $this->config->personalFields);
		$user = new User([
